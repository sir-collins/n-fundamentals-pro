...
Living documentation for this project, kept in sync as the app grows through
the learning roadmap below.

- [`00-roadmap.md`](./00-roadmap.md) — the full project-based NestJS learning
